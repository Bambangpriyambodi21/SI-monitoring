...
public class Adapterforumadmin extends BaseAdapter {
    Activity activity;
    List<Dataforumadmin> items;
    private LayoutInflater inflater;

    public Adapterforumadmin(Activity activity, List<Dataforumadmin> items) {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView==null) convertView = inflater.inflate(R.layout.listforumadmin, null);
...
//        TextView indikator4 = (TextView) convertView.findViewById(R.id.nama4);
        ...
        Dataforumadmin data=items.get(position);
