...
public class infopklMainActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new Adapterinfopkl(infopklMainActivity.this, itemList);
...
//        });
        list.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(infopklMainActivity.this);
...
//                                hapusData(idx);
    ...
    private void detailpenempatan(String idpp) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLEDIT,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            Intent intent = new Intent(infopklMainActivity.this, detailinfopklMainActivity.class);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(infopklMainActivity.this, "Gagal Koneksi Ke server, Cek setingan koneksi anda", Toast.LENGTH_LONG).show();
            }
        })
        {
    ...
    public void dialogForm(String idinfo,String ketinfo,String detinfo,String button){
        AlertDialog.Builder dialogForm = new AlertDialog.Builder(infopklMainActivity.this);
        inflater = getLayoutInflater();
        View viewDialog = inflater.inflate(R.layout.form_infopkl, null);
        dialogForm.setView(viewDialog);
        dialogForm.setCancelable(true);
        dialogForm.setTitle("Form Data Informasi PKL");
    ...
    public void simpan(){
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLINSERT,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        callVolley();
                        Toast.makeText(infopklMainActivity.this, response, Toast.LENGTH_LONG).show();
                    }
                }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
