...
public class monitoringasMainActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    public static final String URLSELECT = "https://monitoring11a.000webhostapp.com/PROJEK/SELECTM.php";
    public static final String URLDELETE = "https://monitoring11a.000webhostapp.com/PROJEK/DELETEM.php";
    public static final String URLEDIT = "https://monitoring11a.000webhostapp.com/PROJEK/EDITM.php";
    public static final String URLINSERT = "https://monitoring11a.000webhostapp.com/PROJEK/INSERTM.php";
    ListView list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.monitoringactivity_mains);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setIcon(R.drawable.logo3);
        swipe = (SwipeRefreshLayout) findViewById(R.id.swipe);
        list = (ListView) findViewById(R.id.list);

        adapter = new Adaptermonitoring(monitoringasMainActivity.this, itemList);
...
//                dialogForm("","","","","","","","","Tambah");
                startActivity(new Intent(monitoringasMainActivity.this, monitoringMainActivity.class));
            }
        });
        list.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(monitoringasMainActivity.this);
    ...
    private void detailpenempatan(String idpp) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLEDIT,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            Intent intent = new Intent(monitoringasMainActivity.this, detailmonitoringMainActivity.class);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(monitoringasMainActivity.this, "Gagal Koneksi Ke server, Cek setingan koneksi anda", Toast.LENGTH_LONG).show();
            }
        })
        {
    ...
    public void dialogForm(String id,String tgl,String nis,String jam,String kegiatan,String lokasi,String user,String foto,String button){
        AlertDialog.Builder dialogForm = new AlertDialog.Builder(monitoringasMainActivity.this);
    ...
    public void simpan(){
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLINSERT,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        callVolley();
                        Toast.makeText(monitoringasMainActivity.this, response, Toast.LENGTH_LONG).show();
                    }
                }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
