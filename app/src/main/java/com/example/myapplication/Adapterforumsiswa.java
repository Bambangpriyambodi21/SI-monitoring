...
public class Adapterforumsiswa extends BaseAdapter {
    Activity activity;
    List<Dataforumsiswa> items;
    private LayoutInflater inflater;

    public Adapterforumsiswa(Activity activity, List<Dataforumsiswa> items) {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView==null) convertView = inflater.inflate(R.layout.listforumsiswa, null);
...
//        TextView indikator4 = (TextView) convertView.findViewById(R.id.nama4);
        ...
        Dataforumsiswa data=items.get(position);
